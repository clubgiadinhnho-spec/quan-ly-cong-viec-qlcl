      ...
      >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="text-sm font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-lg">{user.name}</span>
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 custom-scrollbar">
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 flex items-start gap-4">
            ...
            <div className="text-[11px] text-amber-800 leading-relaxed font-semibold pt-1">
              <strong>NGUYÊN TẮC ỦY QUYỀN:</strong> Việc bật các quyền này cho phép nhân viên thực hiện các hành động thay thế Trưởng phòng. Nhân viên sẽ được gắn nhãn <span className="bg-amber-200 px-1.5 py-0.5 rounded font-black text-[9px] uppercase tracking-tighter mx-1 inline-block">QUYỀN TP</span> trên hệ thống.
            </div>
          </div>
